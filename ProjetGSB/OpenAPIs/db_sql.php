...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.2&nocache=4709301004ltr&server=1">
...
<div class='hide js-show'>    <form method="get" action="index.php" class="disableAjax">
    <input type="hidden" name="db" value="gsb"><input type="hidden" name="table" value=""><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="633d2b67793b5253474169384e263a56">
    ...
    <form method="post" id="login_form" action="index.php" name="login_form" class="disableAjax hide login js-show">
        <fieldset>
        <legend><input type="hidden" name="set_session" value="f5mpt0fub1bgrr4gtkhi4p3lcl">Log in<a href="doc/html/index.html" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a></legend><div class="item">
...
</select></div></fieldset><fieldset class="tblFooters"><input class="btn btn-primary" value="Go" type="submit" id="input_go"><input type="hidden" name="target" value="db_sql.php"><input type="hidden" name="db" value="gsb"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="633d2b67793b5253474169384e263a56"></fieldset>
    </form></div>
  </div>
  </body>
</html>
